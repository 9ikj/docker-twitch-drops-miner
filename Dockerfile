# Pull base image.
FROM jlesage/baseimage-gui:debian-11-v4.6
...
RUN apt-get install -y wget unzip libc6 gir1.2-ayatanaappindicator3-0.1 locales fonts-noto-color-emoji fonts-wqy-zenhei
RUN wget -P /tmp/ https://github.com/9ikj/TwitchDropsMiner/releases/download/dev-build/Twitch.Drops.Miner.Linux.PyInstaller.zip
